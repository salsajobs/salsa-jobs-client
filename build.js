...
// error.html
fs.writeFileSync(OUTPUT_FILE_ERROR, fs.readFileSync(SRC_FILE_INFO, 'utf8'), 'utf8');
// privacy.html
fs.writeFileSync(OUTPUT_FILE_PRIVACY, fs.readFileSync(SRC_FILE_INFO, 'utf8'), 'utf8');